  ...
  (let* ((bg              "#1b182c")
    ...
    (custom-theme-set-faces
     ...
     `(whitespace-line             ((,c (:background ,current-line :foreground ,magenta))
                                    (,ct (:background ,ct-current-line :foreground ,ct-magenta))))
     ;; workgroups2
     ...
     `(org-meta-line             ((,c (:foreground ,doc-comments))
                                  (,ct (:foreground ,ct-doc-comments))))
     `(org-block-begin-line      ((,c (:foreground ,cyan :bold ,bold :height 1.1))
                                  (,ct (:foreground ,ct-cyan :bold ,bold))))
     ...
     `(org-document-title        ((,c (:foreground ,cyan :height 1.2))
                                  (,ct (:foreground ,ct-cyan :height 1.2))))
     `(org-level-1               ((,c (:foreground ,blue :bold ,bold :height 1.2))
                                  (,ct (:foreground ,ct-blue :bold ,bold :height 1.2))))
     `(org-level-2               ((,c (:foreground ,blue :height 1.1))
                                  (,ct (:foreground ,ct-blue :height 1.1))))
     `(org-level-3               ((,c (:foreground ,blue :height 1.1))
                                  (,ct (:foreground ,ct-blue :height 1.1))))
