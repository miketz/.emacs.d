...
(let* ((class        t)
       ...
       (mode-line-fg (aref `["#8FB28F" ,fg       ,todo-tmp "#FFFFFF"] i))
       (mode-line-bg (aref `["#151515" "#121212" ,todo-tbg "#FFFF00"] i))
       (ml-inact-fg  (aref `["#5F7F5F" ,fg       ,todo-tmp "#FFFFFF"] i))
       (ml-inact-bg  (aref `["#383838" "#3A3A3A" ,todo-tbg "#0000FF"] i))
       (ml-bufferid  (aref `["#F0DFAF" "#FFFFAF" ,todo-tmp "#FFFFFF"] i))
