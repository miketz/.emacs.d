...
(let* ((class        t)
       ...
       (mode-line-fg (aref `["#8FB28F" ,todo-tmp ,todo-tmp "#FFFFFF"] i))
       (mode-line-bg (aref `["#151515" ,todo-tbg ,todo-tbg "#FFFF00"] i))
       (ml-inact-fg  (aref `["#5F7F5F" ,todo-tmp ,todo-tmp "#FFFFFF"] i))
       (ml-inact-bg  (aref `["#383838" ,todo-tbg ,todo-tbg "#0000FF"] i))
       (ml-bufferid  (aref `["#F0DFAF" ,todo-tmp ,todo-tmp "#FFFFFF"] i))
