...
;;; https://raw.githubusercontent.com/konrad1977/emacs/main/themes/kanagawa-theme.el
...
(autothemer-deftheme
 ...
 ;; Customize faces
  ...
  (org-block-begin-line                 (:background sumiInk-0 :foreground dragonBlue))
  ...
  (lsp-headerline-breadcrumb-path-error-face (:underline (:color springGreen :style 'wave)
                                                         :foreground sumiInk-4 :background sumiInk-0))
