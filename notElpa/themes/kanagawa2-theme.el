;;; kanagawa2-theme.el --- An elegant theme inspired by The Great Wave off Kanagawa -*- lexical-binding: t -*-
...
(defgroup kanagawa2-theme nil
  "Kanagawa-theme options."
  :group 'faces)

(defcustom kanagawa2-theme-comment-italic t
  "Enable italics for comments and also disable background."
  :type 'boolean
  :group 'kanagawa2-theme)

(defcustom kanagawa2-theme-keyword-italic t
  "Enable italics for keywords."
  :type 'boolean
  :group 'kanagawa2-theme)

(defcustom kanagawa2-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'kanagawa2-theme)

(defcustom kanagawa2-theme-org-bold t
  "Inherit text bold for org headings."
  :type 'boolean
  :group 'kanagawa2-theme)

(defcustom kanagawa2-theme-org-priority-bold t
  "Inherit text bold for priority items in agenda view."
  :type 'boolean
  :group 'kanagawa2-theme)

(defcustom kanagawa2-theme-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'kanagawa2-theme)

(defcustom kanagawa2-theme-underline-parens t
  "If non-nil, underline matching parens when using `show-paren-mode' or similar."
  :type 'boolean
  :group 'kanagawa2-theme)

(defcustom kanagawa2-theme-custom-colors nil
  "Specify a list of custom colors."
  :type 'list
  :group 'kanagawa2-theme)

(deftheme kanagawa2 "An elegant theme inspired by The Great Wave off Kanagawa by Katsushika Hokusa.")

(eval-when-compile
  (defun kanagawa2-theme-true-color-p ()
    (or (display-graphic-p)
	(= (tty-display-color-cells) 16777216)))
  (defvar kanagawa2-theme-dark-palette
    `((fuji-white      ,(if (kanagawa2-theme-true-color-p) "#DCD7BA" "#ffffff"))
      (old-white       ,(if (kanagawa2-theme-true-color-p) "#C8C093" "#ffffff"))
      (sumi-ink-0      ,(if (kanagawa2-theme-true-color-p) "#16161D" "#000000"))
      (sumi-ink-1b     ,(if (kanagawa2-theme-true-color-p) "#1f1f28" "#000000"))
      (sumi-ink-1      ,(if (kanagawa2-theme-true-color-p) "#1F1F28" "#080808"))
      (sumi-ink-2      ,(if (kanagawa2-theme-true-color-p) "#2A2A37" "#121212"))
      (sumi-ink-3      ,(if (kanagawa2-theme-true-color-p) "#363646" "#303030"))
      (sumi-ink-4      ,(if (kanagawa2-theme-true-color-p) "#54546D" "#303030"))
      (wave-blue-1     ,(if (kanagawa2-theme-true-color-p) "#223249" "#4e4e4e"))
      (wave-blue-2     ,(if (kanagawa2-theme-true-color-p) "#2D4F67" "#585858"))
      (wave-aqua-1     ,(if (kanagawa2-theme-true-color-p) "#6A9589" "#6a9589"))
      (wave-aqua-2     ,(if (kanagawa2-theme-true-color-p) "#7AA89F" "#717C7C"))
      (winter-green    ,(if (kanagawa2-theme-true-color-p) "#2B3328" "#585858"))
      (winter-yellow   ,(if (kanagawa2-theme-true-color-p) "#49443C" "#585858"))
      (winter-red      ,(if (kanagawa2-theme-true-color-p) "#43242B" "#585858"))
      (winter-blue     ,(if (kanagawa2-theme-true-color-p) "#252535" "#585858"))
      (autumn-green    ,(if (kanagawa2-theme-true-color-p) "#76946A" "#585858"))
      (autumn-red      ,(if (kanagawa2-theme-true-color-p) "#C34043" "#585858"))
      (autumn-yellow   ,(if (kanagawa2-theme-true-color-p) "#DCA561" "#585858"))
      (samurai-red     ,(if (kanagawa2-theme-true-color-p) "#E82424" "#585858"))
      (ronin-yellow    ,(if (kanagawa2-theme-true-color-p) "#FF9E3B" "#585858"))
      (dragon-blue     ,(if (kanagawa2-theme-true-color-p) "#658594" "#658594"))
      (fuji-gray       ,(if (kanagawa2-theme-true-color-p) "#727169" "#717C7C"))
      (spring-violet-1 ,(if (kanagawa2-theme-true-color-p) "#938AA9" "#717C7C"))
      (oni-violet      ,(if (kanagawa2-theme-true-color-p) "#957FB8" "#717C7C"))
      (crystal-blue    ,(if (kanagawa2-theme-true-color-p) "#7E9CD8" "#717C7C"))
      (spring-violet-2 ,(if (kanagawa2-theme-true-color-p) "#9CABCA" "#717C7C"))
      (spring-blue     ,(if (kanagawa2-theme-true-color-p) "#7FB4CA" "#717C7C"))
      (light-blue      ,(if (kanagawa2-theme-true-color-p) "#A3D4D5" "#717C7C"))
      (spring-green    ,(if (kanagawa2-theme-true-color-p) "#98BB6C" "#717C7C"))
      (_boat-yellow-1   ,(if (kanagawa2-theme-true-color-p) "#938056" "#717C7C"))
      (boat-yellow-2   ,(if (kanagawa2-theme-true-color-p) "#C0A36E" "#717C7C"))
      (carp-yellow     ,(if (kanagawa2-theme-true-color-p) "#E6C384" "#717C7C"))
      (sakura-pink     ,(if (kanagawa2-theme-true-color-p) "#D27E99" "#717C7C"))
      (wave-red        ,(if (kanagawa2-theme-true-color-p) "#E46876" "#717C7C"))
      (peach-red       ,(if (kanagawa2-theme-true-color-p) "#FF5D62" "#717C7C"))
      (surimi-orange   ,(if (kanagawa2-theme-true-color-p) "#FFA066" "#717C7C"))
      (_katana-gray     ,(if (kanagawa2-theme-true-color-p) "#717C7C" "#717C7C"))
      (comet           ,(if (kanagawa2-theme-true-color-p) "#54536D" "#4e4e4e")))
    "Default palette for Kanagawa dark theme."))

(defmacro kanagawa2-theme-define-dark-theme (theme &rest faces)
  "Overwrite dark palette of THEME and load FACES."
  (if (boundp 'kanagawa2-theme-custom-colors)
      `(let* ((class '((class color) (min-colors 89)))
	  ,@(append kanagawa2-theme-dark-palette kanagawa2-theme-custom-colors))
	 (custom-theme-set-faces,theme ,@faces))
    `(let* ((class '((class color) (min-colors 89)))
	    ,@(append kanagawa2-theme-dark-palette))
       (custom-theme-set-faces,theme ,@faces))))

(kanagawa2-theme-define-dark-theme
 'kanagawa2
 ;; Customize faces
 ...
 `(font-lock-keyword-face                        ((,class (:foreground ,oni-violet :weight semi-bold :slant ,(if kanagawa2-theme-keyword-italic 'italic 'normal)))))
 ...
 `(font-lock-comment-face                        ((,class (:foreground ,fuji-gray :slant ,(if kanagawa2-theme-keyword-italic 'italic 'normal)))))
 `(font-lock-comment-delimiter-face              ((,class (:foreground ,fuji-gray :slant ,(if kanagawa2-theme-keyword-italic 'italic 'normal)))))
 ...
 `(org-level-1                                   ((,class (:inherit bold :foreground ,peach-red :height ,(if kanagawa2-theme-org-height 1.3 1.0) :weight ,(if kanagawa2-theme-org-bold 'unspecified 'normal)))))
 `(org-level-2                                   ((,class (:inherit bold :foreground ,spring-violet-2 :height ,(if kanagawa2-theme-org-height 1.2 1.0) :weight ,(if kanagawa2-theme-org-bold 'unspecified 'normal)))))
 `(org-level-3                                   ((,class (:foreground ,boat-yellow-2 :height ,(if kanagawa2-theme-org-height 1.1 1.0)))))
 ...
 `(org-priority                                  ((,class (:foreground ,peach-red :inherit bold :weight ,(if kanagawa2-theme-org-priority-bold 'unspecified 'normal)))))
 ...
 ;; show-paren
 `(show-paren-match                              ((,class (:background ,wave-aqua-1 :foreground ,sumi-ink-0 :weight bold :underline ,(when kanagawa2-theme-underline-parens t)))))
 `(show-paren-match-expression                   ((,class (:background ,wave-aqua-1 :foreground ,sumi-ink-0 :weight bold))))
 `(show-paren-mismatch                           ((,class (:background ,peach-red :foreground ,old-white :underline ,(when kanagawa2-theme-underline-parens t)))))
...
(provide-theme 'kanagawa2)
;;; kanagawa2-theme.el ends here
