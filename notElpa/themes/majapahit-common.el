...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ;;                                        DARK      LIGHT
        (base          (if (eq variant 'dark)   "#F7E6D4" "#60585E" ))
        (base2         (if (eq variant 'dark)   "#5D5147" "#ADA190" ))
        (base3         (if (eq variant 'dark)   "#D7D7AF" "#5F5F87" ))
        (cursor        (if (eq variant 'dark)   "#917154" "#806C5B" ))
        (bg1           (if (eq variant 'dark)   "#242424" "#FDF9EA" ))
        (bg2           (if (eq variant 'dark)   "#333333" "#F7F3E5" ))
        (bg3           (if (eq variant 'dark)   "#3C3C3C" "#E0DDCE" ))
        (bg4           (if (eq variant 'dark)   "#6F6F6F" "#ADA790" ))
        (key1          (if (eq variant 'dark)   "#D66F84" "#B34D6C" ))
        (key2          (if (eq variant 'dark)   "#D4B292" "#7D7470" ))
        (builtin       (if (eq variant 'dark)   "#9C8772" "#806C5B" ))
        (keyword       (if (eq variant 'dark)   "#D75F87" "#C45C7B" ))
        (const         (if (eq variant 'dark)   "#D49A8A" "#AE6A56" ))
        (comment       (if (eq variant 'dark)   "#707070" "#979987" ))
        (func          (if (eq variant 'dark)   "#989584" "#777E62" ))
        (str           (if (eq variant 'dark)   "#9DA69E" "#6B6254" ))
        (type          (if (eq variant 'dark)   "#94B1A3" "#4D6E66" ))
        ...
        (inf           (if (eq variant 'dark)   "#81998E" "#7CA194" ))
        ...
        (cyan          (if (eq variant 'dark)   "#9C8772" "#6B6254" ))
        (violet        (if (eq variant 'dark)   "#A8938C" "#685672" ))
        ...
        (org-h1-bg     (if (eq variant 'dark)   "#333333" "#F0ECDE" ))
        (org-h2-bg     (if (eq variant 'dark)   "#3C3C3C" "#E0DDCE" ))
        (org-h3-bg     (if (eq variant 'dark)   "#3F3F3F" "#F2EDDC" ))
        (org-h4-bg     (if (eq variant 'dark)   "#242424" "#F6F1E1" ))
        (highlight     (if (eq variant 'dark)   "#1C1C1C" "#EDE8DB" ))
        ...
        ;;                                         DARK      LIGHT
        (t-base          (if (eq variant 'dark)   "#FFD7AF" "#5F5F5F" ))
        ...
        (t-bg1           (if (eq variant 'dark)   "#242424" "#FDF9EA" ))
        (t-bg2           (if (eq variant 'dark)   "#333333" "#FFFFD7" ))
        (t-bg3           (if (eq variant 'dark)   "#444444" "#D7D7D7" ))
        ...
        (t-const         (if (eq variant 'dark)   "#D7875F" "#D7875F" ))
        (t-comment       (if (eq variant 'dark)   "#707070" "#878787" ))
        (t-func          (if (eq variant 'dark)   "#AFAFAF" "#AFAF87" ))
        ...
        (t-cyan          (if (eq variant 'dark)   "#AF8700" "#707070" ))
        ...
        (t-highlight     (if (eq variant 'dark)   "#1C1C1C" "#EEEEEE" ))
...
;;;;; font-locks
     ...
     `(font-lock-string-face                           ((,class (:foreground ,str :bold t))
                                                        (,t-class (:foreground ,t-str :bold t))))
...
;;;;; extra font-locks
     `(clojure-keyword-face                            ((,class (:foreground ,mkwd :underline t :weight bold))
                                                        (,t-class (:foreground ,t-mkwd :underline t :weight bold))))
...
;;;;; auctex / latex-mode
     ...
     `(company-preview-search                          ((,class (:foreground ,const))
                                                        (,t-class (:foreground ,t-const))))
     ...
     `(company-tooltip-annotation                      ((,class (:foreground ,inf :background ,bg2))
                                                        (,t-class (:foreground ,t-inf :background ,t-bg2))))
     ...
     `(company-tooltip-selection                       ((,class (:foreground ,const :background ,highlight))
                                                        (,t-class (:foreground ,t-const :background ,t-highlight))))
...
;;;;; mode-line
     `(mode-line                                 ((,class (:foreground ,bg4 :background ,highlight :box (:color ,m-line-brdr :line-width 1)))
                                                  (,t-class (:foreground ,t-bg4 :background ,t-highlight :box (:color ,m-line-brdr :line-width 1)))))
     `(mode-line-inactive                        ((,class (:foreground ,base2 :background ,bg2 :box (:color ,m-line-brdr :line-width 1)))
                                                  (,t-class (:foreground ,t-base2 :background ,t-bg2 :box (:color ,t-m-line-brdr :line-width 1)))))
