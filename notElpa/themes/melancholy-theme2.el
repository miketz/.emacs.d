;;; melancholy-theme2.el --- A dark theme that's pretty sad -*- lexical-binding: t; -
...
;;; Commentary:
;; ========================================
;; A dark theme thats pretty sad really.  > Emacs 28.1
;;
...
;; Theme Faces
  (custom-theme-set-faces
    ...
    `(helm-source-header ((t (:family ,font-cursive :height 1.9 :foreground ,my-contrast :underline t ))))
    ...
    `(org-level-4 ((t :family ,font-cursive :foreground ,my-contrast :height 1.8 :weight regular )))
...
(provide-theme 'melancholy2)

;;; melancholy-theme2.el ends here
