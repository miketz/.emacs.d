;;; modus-vivendi-old-theme.el --- Accessible dark theme (WCAG AAA) -*- lexical-binding:t -*-
...
(provide-theme 'modus-vivendi-old)

(provide 'modus-vivendi-old-theme)
;;; modus-vivendi-old-theme.el ends here
