 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'nothing
	...
	`(term-color-black ((,class (:foreground ,"#282828"))))
        `(term-color-blue ((,class (:foreground ,"#223daa"))))
        `(term-color-red ((,class (:foreground ,"#ab0f0f"))))
        `(term-color-green ((,class (:foreground ,"#259f17"))))
        `(term-color-yellow ((,class (:foreground ,"#919605"))))
        `(term-color-magenta ((,class (:foreground ,"#790f77"))))
        `(term-color-cyan ((,class (:foreground ,"#11779a"))))
