;;; warm-brown-theme.el --- Chalkish warm-brown colors. -*- lexical-binding: t -*-
...
(deftheme warm-brown "warm-brown color theme")

(defvar warm-brown-color-cnt (display-color-cells)
...
Example:
    (let ((warm-brown-color-cnt 8))
      (load-theme 'warm-brown t))")

(let* ((class        t)
       (i            (cond ((>= warm-brown-color-cnt 16777216) 0)
                           ((>= warm-brown-color-cnt 256)      1)
                           ((>= warm-brown-color-cnt 16)       2)
                           ((>= warm-brown-color-cnt 8)        3)
                           (t                                3)))
       ...
       (bg           (aref `["#2c271e" "#262626" "#000000" "#000000"] i))
  ...
  (custom-theme-set-faces
   ...
   `(line-number ((,class ,@(cond ((= warm-brown-color-cnt 16)
                                     `(:inherit mode-line))
   ...
   `(font-lock-comment-face ((,class (:foreground "#8FB28F" :background "#2b3121"))))
   ...
   `(font-lock-string-face ((,class (:foreground "LightSalmon" :background "#38382e"))))
   ...
   ;; swiper, ivy, counsel
   `(swiper-line-face ((,class (:background ,(if (= warm-brown-color-cnt 16)
												 highlight
											   "gray30")
											,@(cond ((= warm-brown-color-cnt 16)
													 `(:foreground ,fg))
													(t nil))))))
   ...
   `(company-scrollbar-bg ((,class (:background ,scrollb-bg
                                                ;;:inherit company-tooltip-scrollbar-track
                                                ))))
   `(company-scrollbar-fg ((,class (:background ,scrollb-fg
                                                ;;:inherit company-tooltip-scrollbar-thumb
                                                ))))
   ...
   ;; TODO: customize colors for warm-brown
   ...
   `(tty-menu-selected-face ((,class :background ,(if (<= warm-brown-color-cnt 256)
                                                      "blue"
                                                    fainter))))
...
(provide-theme 'warm-brown)

;;; warm-brown-theme.el ends here
