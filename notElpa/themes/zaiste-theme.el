;;; from https://raw.githubusercontent.com/zaiste/zaiste-emacs-theme/master/zaiste-theme.el
;;; commented code with out `after!' and `&override'.
;;; Maybe I need the latest doom-themes files for to support these funcs/macros.
...
(def-doom-theme zaiste
  ...
  ((font-lock-comment-face
   ...
   (line-number-current-line :foreground base8)
