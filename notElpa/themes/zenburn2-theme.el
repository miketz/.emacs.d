...
;;;;; org-mode
   ...
   `(org-level-1 ((t (:inherit default :foreground ,zenburn-orange))))
   `(org-level-2 ((t (:inherit default :foreground ,zenburn-green+4))))
   `(org-level-3 ((t (:inherit default :foreground ,zenburn-blue-1))))
   `(org-level-4 ((t (:inherit default :foreground ,zenburn-yellow-2))))
   `(org-level-5 ((t (:inherit default :foreground ,zenburn-cyan))))
   `(org-level-6 ((t (:inherit default :foreground ,zenburn-green+2))))
   `(org-level-7 ((t (:inherit default :foreground ,zenburn-red+2))))
   `(org-level-8 ((t (:inherit default :foreground ,zenburn-magenta))))
   ...
   `(org-document-title ((t (:inherit default :foreground ,zenburn-blue
                                      :weight bold))))
...
;;;;; outline
   `(outline-1 ((t (:inherit default :foreground ,zenburn-orange))))
   `(outline-2 ((t (:inherit default :foreground ,zenburn-green+4))))
   `(outline-3 ((t (:inherit default :foreground ,zenburn-blue-1))))
   `(outline-4 ((t (:inherit default :foreground ,zenburn-yellow-2))))
   `(outline-5 ((t (:inherit default :foreground ,zenburn-cyan))))
   `(outline-6 ((t (:inherit default :foreground ,zenburn-green+2))))
   `(outline-7 ((t (:inherit default :foreground ,zenburn-red-4))))
   `(outline-8 ((t (:inherit default :foreground ,zenburn-blue-4))))
;;;;; p4
...
;;; Footer
(provide-theme 'zenburn2)

;;; zenburn2-theme.el ends here